...
try {
	...
	WebUI.sendKeys(findTestObject('ESO/Page_Age_Verification/input_Age Verification_year'), CustomKeywords.'helpers.getTodayDate.OverYear'())
	
	WebUI.click(findTestObject('ESO/Page_Age_Verification/button_Submit'))
	
	WebUI.verifyElementNotPresent(findTestObject('ESO/Page_Age_Verification/h4_Access Denied'), 0)
